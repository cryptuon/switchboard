...
- [First Deployment](first-deployment.md) - Deploy your first cross-chain application
...
!!! tip "Start with Development Mode"
    Always start with `--dev-mode` to test on testnets before deploying to production.

## Next Steps

Ready to begin? Start with the [Quick Start Guide](quickstart.md) to deploy your first cross-chain application in under 5 minutes.
